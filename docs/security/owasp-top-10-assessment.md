...
| A02 Cryptographic Failures                     | Partial     | Signed media/password/consent tokens and environment-gated secrets are present            | Add explicit key rotation and data-retention guidance                                   |
...
| A09 Security Logging and Monitoring Failures   | Partial     | Admin audit logs and incident SOP exist                                                   | Add structured operational alerting/SLO ownership documentation                         |
...
- explicit CSRF/origin validation assessment for browser-originated mutations
- privacy and data-retention policy for guestbook, audit, backup, and consent
  records
- observability and alert ownership for production incidents
