...
- _Story:_ As an admin I want to sign in so I can manage the memorial.
- _Acceptance:_ Admin can log in via email and see admin dashboard within 5s.

**US-02 (Upload images)**

- _Story:_ As an admin I want to upload photos so I can populate the gallery.
- _Acceptance:_ Admin can select multiple images in Cloudinary widget, image metadata is saved in DB, and transformed thumbnails appear in gallery within 10s for small batches.

**US-03 (Generate QR)**

- _Story:_ As an admin I want an SVG QR for the short URL so I can send to the engraver.
- _Acceptance:_ Admin can download an SVG and PNG (300 DPI) generated from the short redirect URL.

**US-04 (Guestbook)**

- _Story:_ As a visitor I want to leave a message.
- _Acceptance:_ Visitor posts message; admin receives unapproved entry and can approve/delete it.
