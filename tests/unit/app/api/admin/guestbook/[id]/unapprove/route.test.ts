import { POST } from '@/app/api/admin/guestbook/[id]/unapprove/route'
...
describe('POST /api/admin/guestbook/[id]/unapprove', () => {
  beforeEach(() => {
  ...
  it('unapproves guestbook entry for authorized owner', async () => {
