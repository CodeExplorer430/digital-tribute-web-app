...
describe('AdminDashboardView', () => {
  ...
  it('renders dashboard actions and passes pages to TributeList', () => {
    ...
    expect(
      screen.getByRole('link', { name: /Create New Memorial/i })
    ).toHaveAttribute('href', '/admin/memorials/new')
    expect(
      screen.getByRole('link', { name: 'Open Guestbook' })
    ).toHaveAttribute('href', '/admin/guestbook')
    expect(
      screen.getByRole('link', { name: 'Manage Redirects' })
